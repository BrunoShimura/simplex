...
(function (root) {
  ...
  var DivisionByZero = (Fraction["DivisionByZero"] = createError(
    "DivisionByZero"
  ));
  var InvalidParameter = (Fraction["InvalidParameter"] = createError(
    "InvalidParameter"
  ));
  ...
  Fraction.prototype = {
    ...
    pow: function (m) {
      if (m < 0) {
        return new Fraction(
          Math.pow(this["s"] * this["d"], -m),
          Math.pow(this["n"], -m)
        );
      } else {
        return new Fraction(
          Math.pow(this["s"] * this["n"], m),
          Math.pow(this["d"], m)
        );
      }
    },
